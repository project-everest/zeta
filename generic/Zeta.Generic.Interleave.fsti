...
let idxfn_il_base #vspec #n #b (tfn: T.idxfn_t vspec b)
  (il: verifiable_log vspec n) (i: seq_index il)
  : elem_src b n
  = {e = idxfn tfn il i; s = src il i}

let idxfn_il #b #vspec #n (tfn: T.idxfn_t vspec b)
  : IF.idxfn_t (gen_seq vspec n) _
  = idxfn_il_base tfn
...
val idxfnil_prefix_property (#vspec:_) (#n:_) (#b:_) (tfn: T.idxfn_t vspec b)
  (il: verifiable_log vspec n) (j:nat{j <= S.length il}) (i: nat{i < j})
...
let cond_idxfn_il_base #vspec #n #b #f (m: T.cond_idxfn_t b f)
  (il: verifiable_log vspec n) (i: seq_index il{idxfn f il i})
  : elem_src b n
  = {e = cond_idxfn m il i; s = src il i}

let cond_idxfn_il #vspec #n #b #f (m: T.cond_idxfn_t b f)
  : IF.cond_idxfn_t (elem_src b n) (idxfn f)
  = cond_idxfn_il_base #vspec #n #b #f m

val lemma_filter_map (#vspec #n #b #f:_) (m: T.cond_idxfn_t b f)
    (il: verifiable_log vspec n) (i: seq_index il)
...
let to_appfn_call_res #vspec #n (ep: epoch) = cond_idxfn #vspec #n #_ #_ (T.to_appfn_call_res #vspec ep)
