...
typedef struct K___Zeta_Steel_LogEntry_Types_u256_uint32_t_s
{
  Zeta_Steel_LogEntry_Types_u256 fst;
  uint32_t snd;
}
K___Zeta_Steel_LogEntry_Types_u256_uint32_t;

typedef struct FStar_Pervasives_Native_option__K___Zeta_Steel_LogEntry_Types_u256_uint32_t_s
{
  FStar_Pervasives_Native_option__Zeta_Steel_ApplicationTypes_value_type_tags tag;
  K___Zeta_Steel_LogEntry_Types_u256_uint32_t v;
}
