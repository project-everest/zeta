...
Zeta_Steel_KeyUtils_raw_key Zeta_Steel_KeyUtils_root_raw_key;
...
Zeta_Steel_KeyUtils_raw_key Zeta_Steel_KeyUtils_root_base_key;
...
Zeta_Steel_LogEntry_Types_key Zeta_Steel_LogEntry_Types_root_key;
...
Zeta_Steel_KeyUtils_u256 Zeta_Steel_BitUtils_zero256;
...
static bool compare(Zeta_Steel_HashAccumulator_ha b1, Zeta_Steel_HashAccumulator_ha b2)
{
  ...
  if (c1 != c2)
    ...
    return compare__uint8_t(b1.acc, b2.acc, (uint32_t)32U);
}
...
{
  return check_overflow_add32(x, y);
}
...
Zeta_Steel_KeyUtils_u256 Zeta_Steel_ThreadStateModel_zero;
...
static bool
timestamp_lt(Zeta_Steel_LogEntry_Types_timestamp t0, Zeta_Steel_LogEntry_Types_timestamp t1)
{
  return t0.epoch < t1.epoch || t0.epoch == t1.epoch && t0.counter < t1.counter;
}

static Zeta_Steel_LogEntry_Types_timestamp
max(Zeta_Steel_LogEntry_Types_timestamp t0, Zeta_Steel_LogEntry_Types_timestamp t1)
{
...
static uint32_t epoch_of_timestamp(Zeta_Steel_LogEntry_Types_timestamp t)
{
  return t.epoch;
}
...
get___bool_(Zeta_Steel_AggregateEpochHashes_epoch_tid_bitmaps a, uint32_t i)
{
  ...
  else
  {
    ...
    get_result__uint32_t__bool_ x0;
    if (vopt.tag == FStar_Pervasives_Native_None)
      x0 = ((get_result__uint32_t__bool_){ .tag = Absent });
    else if (vopt.tag == FStar_Pervasives_Native_Some)
    {
      bool *x = vopt.v.snd;
      uint32_t i_ = vopt.v.fst;
      if (i != i_)
        x0 = ((get_result__uint32_t__bool_){ .tag = Missing, { .case_Missing = i_ } });
      else
        x0 = ((get_result__uint32_t__bool_){ .tag = Present, { .case_Present = x } });
    }
    else
      x0 =
...
)
{
  ...
  else
  {
    ...
    {
      Zeta_Steel_EpochHashes_epoch_hashes_t x1 = x0.case_Present;
...
)
{
  ...
  if (res.tag == Found)
  {
    ...
    return compare(ehs.hadd, ehs.hevict);
  }
  else
    return false;
}
...
static Zeta_Steel_KeyUtils_u256
hash_value(Zeta_Steel_HashValue_hasher_t h, Zeta_Steel_LogEntry_Types_value v)
{
  ...
  Hacl_Blake2b_32_blake2b((uint32_t)32U,
    ...
    (uint32_t)0U,
    h.dummy);
  return read_hash_u256(h.hash_buffer);
}
...
typedef struct Zeta_Steel_VerifierTypes_thread_state_t_s
{
  ...
  Zeta_Steel_LogEntry_Types_timestamp *clock;
...
static Zeta_Steel_KeyUtils_raw_key to_base_key(Zeta_Steel_LogEntry_Types_key x)
{
  ...
  else if (x.tag == Zeta_Steel_LogEntry_Types_ApplicationKey)
  {
    ...
    return Zeta_Steel_Application_key_type_to_base_key(k);
  }
  else
  {
    KRML_HOST_EPRINTF("KaRaMeL abort at %s:%d\n%s\n",
...
static option__Zeta_Steel_LogEntry_Types_timestamp next(Zeta_Steel_LogEntry_Types_timestamp t)
{
  FStar_Pervasives_Native_option__uint32_t scrut = check_overflow_add32(t.counter, (uint32_t)1U);
...
)
{
  ...
  else if (vopt.tag == Found)
  {
    ...
    switch (ht)
    {
      case HAdd:
        {
          return ha_add(v.hadd, n, t.serialization_buffer);
        }
      case HEvict:
        {
          return ha_add(v.hevict, n, t.serialization_buffer);
        }
      default:
        {
      ...
      else
      {
        ...
        else
        {
          ...
          if (ok)
          {
            ...
            {
              Zeta_Steel_LogEntry_Types_timestamp t_ = ts_opt.v;
              Zeta_Steel_LogEntry_Types_timestamp clock = t.clock[0U];
              Zeta_Steel_LogEntry_Types_timestamp next_clock = max(clock, t_);
...
{
  return vaddb_core(t, s, ts, thread_id, r);
}
...
{
  return vevictbm_core(t, s, s_, ts);
}

static void nextepoch_core(Zeta_Steel_VerifierTypes_thread_state_t t)
{
  Zeta_Steel_LogEntry_Types_timestamp c = t.clock[0U];
  ...
  {
    uint32_t nxt = res.v;
    Zeta_Steel_LogEntry_Types_timestamp c1 = { .epoch = nxt, .counter = (uint32_t)0U };
    t.clock[0U] = c1;
  }
  else
  {
...
{
  return verify_epoch_core(t, aeh.hashes, aeh.tid_bitmaps, aeh.lock);
}
...
static Zeta_Steel_VerifierTypes_thread_state_t create_basic(uint16_t tid)
{
  ...
  *store =
  ...
  KRML_CHECK_SIZE(sizeof (Zeta_Steel_LogEntry_Types_timestamp), (uint32_t)1U);
  Zeta_Steel_LogEntry_Types_timestamp
  *clock = KRML_HOST_MALLOC(sizeof (Zeta_Steel_LogEntry_Types_timestamp));
  clock[0U]
  = ((Zeta_Steel_LogEntry_Types_timestamp){ .epoch = (uint32_t)0U, .counter = (uint32_t)0U });
  Zeta_Steel_AggregateEpochHashes_all_epoch_hashes
...
{
  bool b = is_value_of(Zeta_Steel_LogEntry_Types_root_key, v);
  if (!!b)
  {
    FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry
    ropt = t.store[as_u320(s)];
    if (!(ropt.tag == FStar_Pervasives_Native_Some))
    {
      ...
      new_entry =
        {
          .key = Zeta_Steel_LogEntry_Types_root_key, .value = v,
...
static Zeta_Steel_VerifierTypes_thread_state_t create1(uint16_t tid)
{
  ...
  if (tid == (uint16_t)0U)
  {
    madd_to_store_root(ts, (uint16_t)0U, init_value(Zeta_Steel_LogEntry_Types_root_key));
    return ts;
  }
  else
    return ts;
...
)
{
  ...
  else if (le.tag == AddB)
  {
    ...
    Zeta_Steel_LogEntry_Types_timestamp ts = le.case_AddB.ts;
...
Zeta_Steel_Main_top_level_state *Zeta_Steel_Main_init()
{
  ...
  *all_threads =
  ...
  Zeta_Steel_Main_top_level_state
  *buf = KRML_HOST_MALLOC(sizeof (Zeta_Steel_Main_top_level_state));
  buf[0U] = r;
  return buf;
}
...
)
{
  ...
  return verify_log_aux(t_, tid, len, input, out_len, output);
}
