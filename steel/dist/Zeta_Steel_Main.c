...
extern void Hacl_Blake2b_32_blake2b(uint32_t nn, uint8_t *sout, uint32_t output, uint8_t *ll);
...
static void free(Zeta_Steel_HashAccumulator_ha s)
{
...
static bool add(Zeta_Steel_HashAccumulator_ha ha1, uint8_t *input, uint32_t l)
{
  ...
  ctr[0U] = (uint32_t)1U;
  Hacl_Blake2b_32_blake2b((uint32_t)32U, acc, l, input);
    ...
    return
      (
        (Zeta_Steel_LogEntry_Types_value){
          ...
          { .case_DValue = { .tag = Zeta_Steel_ThreadStateModel_None } }
        }
      );
  else
    return
...
Zeta_Steel_LogEntry_parser_log_entry(uint32_t x0, uint32_t x1, uint32_t x2, uint8_t *x3);

extern uint32_t
Zeta_Steel_LogEntry_serialize_stamped_record(
  uint32_t x0,
  uint32_t x1,
  uint8_t *x2,
  stamped_record x3
...
extern uint32_t
Zeta_Steel_LogEntry_serialize_value(
  uint32_t x0,
  uint32_t x1,
  uint8_t *x2,
...
Zeta_Steel_LogEntry_parser_u256(uint32_t x0, uint32_t x1, uint32_t x2, uint8_t *x3);
...
static Zeta_Steel_HashValue_hasher_t alloc()
{
  ...
  return ((Zeta_Steel_HashValue_hasher_t){ .serialization_buffer = sb, .hash_buffer = hb });
}

static Zeta_Steel_LogEntry_Types_u256 read_hash_u256(uint8_t *hb)
{
  option__K___Zeta_Steel_LogEntry_Types_u256_uint32_t
  res = Zeta_Steel_LogEntry_parser_u256((uint32_t)32U, (uint32_t)0U, (uint32_t)32U, hb);
...
hash_value(Zeta_Steel_HashValue_hasher_t h, Zeta_Steel_LogEntry_Types_value v)
{
  uint32_t
  n =
    Zeta_Steel_LogEntry_serialize_value((uint32_t)4096U,
      (uint32_t)0U,
      h.serialization_buffer,
      v);
  Hacl_Blake2b_32_blake2b((uint32_t)32U, h.hash_buffer, n, h.serialization_buffer);
...
Zeta_Steel_Application_run_app_function(
  runApp_payload log_perm,
  uint32_t log_bytes,
  uint8_t *log_len,
  uint32_t pl,
  uint32_t pl_pos,
  uint8_t *log_array,
  Zeta_Steel_VerifierTypes_thread_state_t out_bytes
);
...
static uint64_t shift_right_64(uint64_t x, uint16_t w)
{
  if (w == (uint16_t)64U)
    return (uint64_t)0U;
  else
...
{
  Zeta_Steel_LogEntry_Types_u256 kk0 = k.k;
  Zeta_Steel_LogEntry_Types_u256
  zkey = { .v3 = (uint64_t)0U, .v2 = (uint64_t)0U, .v1 = (uint64_t)0U, .v0 = (uint64_t)0U };
  Zeta_Steel_LogEntry_Types_u256 kk;
  if (w <= (uint16_t)64U)
    kk =
      (
        (Zeta_Steel_LogEntry_Types_u256){
          ...
          .v2 = zkey.v2,
          .v1 = zkey.v1,
          .v0 = shift_right_64(kk0.v0, (uint16_t)64U - w)
        }
      );
  else if (w <= (uint16_t)128U)
    kk =
      (
        (Zeta_Steel_LogEntry_Types_u256){
          .v3 = zkey.v3,
          .v2 = zkey.v2,
          .v1 = shift_right_64(kk0.v1, (uint16_t)128U - w),
          .v0 = kk0.v0
        }
      );
  else if (w < (uint16_t)192U)
    kk =
      (
        (Zeta_Steel_LogEntry_Types_u256){
          .v3 = (uint64_t)0U,
          .v2 = shift_right_64(kk0.v2, (uint16_t)192U - w),
          .v1 = kk0.v1,
          .v0 = kk0.v0
        }
      );
    ...
    kk =
      (
        (Zeta_Steel_LogEntry_Types_u256){
          .v3 = shift_right_64(kk0.v3, (uint16_t)256U - w),
          .v2 = kk0.v2,
          .v1 = kk0.v1,
          .v0 = kk0.v0
        }
      );
  return ((Zeta_Steel_LogEntry_Types_base_key){ .k = kk, .significant_digits = w });
}
...
static bool ith_bit(Zeta_Steel_LogEntry_Types_base_key k0, uint16_t i)
{
  ...
  if (i < (uint16_t)64U)
    return (kk.v0 >> (uint32_t)i) % (uint64_t)2U == (uint64_t)1U;
  else if (i < (uint16_t)128U)
    return (kk.v1 >> (uint32_t)(i - (uint16_t)64U)) % (uint64_t)2U == (uint64_t)1U;
  else if (i < (uint16_t)192U)
    return (kk.v2 >> (uint32_t)(i - (uint16_t)128U)) % (uint64_t)2U == (uint64_t)1U;
  else
    return (kk.v3 >> (uint32_t)(i - (uint16_t)192U)) % (uint64_t)2U == (uint64_t)1U;
}
...
extern uint32_t Zeta_Steel_LogEntry_Spec_runapp_payload_offset(log_entry e);
...
)
{
  ...
  {
    FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry
    ropt = t.store[as_u32(s)];
    FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry
    ropt_ = t.store[as_u32(s_)];
    ...
    else if (ropt_.tag == FStar_Pervasives_Native_Some)
    {
      ...
      else if (s2_opt.tag == FStar_Pervasives_Native_Some)
      {
        ...
        else if (r2opt.tag == FStar_Pervasives_Native_Some)
        {
          ...
          K___uint16_t_bool p2new = { .fst = s2, .snd = d2 };
...
{
  return false || x.v3 != y.v3 || x.v2 != y.v2 || x.v1 != y.v1 || x.v0 != y.v0;
}
...
)
{
  return
    false
    || __neq__Zeta_Steel_LogEntry_Types_u256(x.k, y.k)
    || x.significant_digits != y.significant_digits;
}
...
)
{
  return
    false
    || __neq__Zeta_Steel_LogEntry_Types_base_key(x.dhd_key, y.dhd_key)
    || __neq__Zeta_Steel_LogEntry_Types_u256(x.dhd_h, y.dhd_h)
    || x.evicted_to_blum != y.evicted_to_blum;
}
...
)
{
  if (x.tag == Zeta_Steel_LogEntry_Types_Dh_vnone)
    if (y.tag == Zeta_Steel_LogEntry_Types_Dh_vnone)
      return false;
    else
      return true;
  else if (x.tag == Zeta_Steel_LogEntry_Types_Dh_vsome)
  {
    Zeta_Steel_LogEntry_Types_descendent_hash_desc x__0 = x._0;
    if (y.tag == Zeta_Steel_LogEntry_Types_Dh_vsome)
    {
      Zeta_Steel_LogEntry_Types_descendent_hash_desc y__0 = y._0;
      return false || __neq__Zeta_Steel_LogEntry_Types_descendent_hash_desc(y__0, x__0);
    }
    else
      return true;
  }
...
)
{
  return
    false
    || __neq__Zeta_Steel_LogEntry_Types_descendent_hash(x.l, y.l)
    || __neq__Zeta_Steel_LogEntry_Types_descendent_hash(x.r, y.r);
}
...
{
  return !__eq__Zeta_Steel_ApplicationTypes_value_type(x, y);
}
...
{
  if (x.tag == Zeta_Steel_ThreadStateModel_None)
    if (y.tag == Zeta_Steel_ThreadStateModel_None)
      return false;
    else
      return true;
  else if (x.tag == Zeta_Steel_ThreadStateModel_Some)
  {
    Zeta_Steel_ApplicationTypes_value_type x_v = x.v;
    if (y.tag == Zeta_Steel_ThreadStateModel_Some)
    {
      Zeta_Steel_ApplicationTypes_value_type y_v = y.v;
      return false || __neq__Zeta_Steel_ApplicationTypes_value_type(y_v, x_v);
    }
    else
      return true;
  }
...
)
{
  ...
  {
    Zeta_Steel_LogEntry_Types_mval_value x__0 = x.case_MValue;
    if (y.tag == Zeta_Steel_LogEntry_Types_MValue)
    {
      Zeta_Steel_LogEntry_Types_mval_value y__0 = y.case_MValue;
      return false || __neq__Zeta_Steel_LogEntry_Types_mval_value(y__0, x__0);
    }
    else
      return true;
  }
  else if (x.tag == Zeta_Steel_LogEntry_Types_DValue)
  {
    Zeta_Steel_ThreadStateModel_data_value x__0 = x.case_DValue;
    if (y.tag == Zeta_Steel_LogEntry_Types_DValue)
    {
      Zeta_Steel_ThreadStateModel_data_value y__0 = y.case_DValue;
      return false || __neq__Zeta_Steel_ThreadStateModel_data_value(y__0, x__0);
    }
    else
      return true;
  }
        ...
        else
        {
          ...
          else if (scrut0.tag == FStar_Pervasives_Native_Some)
          {
            ...
            if (dh_.tag == Zeta_Steel_LogEntry_Types_Dh_vnone)
              if (__neq__Zeta_Steel_LogEntry_Types_value(gv, init_value(gk)))
              {
                bool b1 = fail_as(t);
                return b1;
              }
            ...
            else if (dh_.tag == Zeta_Steel_LogEntry_Types_Dh_vsome)
            {
              ...
              else if (__neq__Zeta_Steel_LogEntry_Types_value(gv, init_value(gk)))
              {
                bool b1 = fail_as(t);
                return b1;
              }
...
)
{
  ...
  else if (vopt.tag == Found)
  {
    ...
    uint32_t
    n =
      Zeta_Steel_LogEntry_serialize_stamped_record((uint32_t)4096U,
        (uint32_t)0U,
        t.serialization_buffer,
        sr);
...
static void vevictm_core(Zeta_Steel_VerifierTypes_thread_state_t t, uint16_t s, uint16_t s_)
{
  ...
  {
    FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry e = t.store[as_u32(s)];
    FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry
    e_ = t.store[as_u32(s_)];
    __FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry_FStar_Pervasives_Native_option__Zeta_Steel_ThreadStateModel_store_entry
    scrut0 = { .fst = e, .snd = e_ };
    ...
    )
    {
      ...
      else
      {
        ...
        if (scrut.tag == FStar_Pervasives_Native_Some)
        {
          ...
          {
            Zeta_Steel_LogEntry_Types_base_key k2 = dh_._0.dhd_key;
            if (__neq__Zeta_Steel_LogEntry_Types_base_key(k2, k))
              fail(t);
            else
            {
            ...
            else
            {
              ...
              if (scrut.tag == FStar_Pervasives_Native_Some)
              {
                ...
                else if (dh_.tag == Zeta_Steel_LogEntry_Types_Dh_vsome)
                {
                  ...
                  if
                  (
                    __neq__Zeta_Steel_LogEntry_Types_base_key(k2,
                      k)
                    || b2 == Zeta_Steel_LogEntry_Types_Vtrue
                  )
                  {
...
{
  option__K___Zeta_Steel_LogEntry_Types_log_entry_uint32_t
  res = Zeta_Steel_LogEntry_parser_log_entry(len, log_pos, len - log_pos, log);
  if (res.tag == FStar_Pervasives_Native_None)
    return
      (
  ...
  else if (res.tag == FStar_Pervasives_Native_Some)
  {
    ...
    if (le.tag == RunApp)
    {
      ...
      uint32_t pl_pos0 = Zeta_Steel_LogEntry_Spec_runapp_payload_offset(le);
