...
{
  Zeta_Steel_KeyUtils_root_raw_key =
    (
  ...
  Zeta_Steel_KeyUtils_root_base_key = Zeta_Steel_KeyUtils_root_raw_key;
  Zeta_Steel_LogEntry_Types_root_key =
    (
      (Zeta_Steel_LogEntry_Types_key){
        .tag = Zeta_Steel_LogEntry_Types_InternalKey,
        { .case_InternalKey = Zeta_Steel_KeyUtils_root_base_key }
      }
    );
  uint64_t z = FStar_UInt64_zero;
  Zeta_Steel_BitUtils_zero256 =
    ((Zeta_Steel_KeyUtils_u256){ .v3 = z, .v2 = z, .v1 = z, .v0 = z });
  Zeta_Steel_ThreadStateModel_zero = Zeta_Steel_BitUtils_zero256;
}
