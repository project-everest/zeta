...
#ifndef __Incr_counter_param_H
#define __Incr_counter_param_H
...
typedef struct Incr_counter_param_incr_counter_param_s
{
  uint64_t k;
  uint16_t s_r;
}
...
uint64_t
Incr_counter_param_incr_counter_param_validator(LowParse_Slice_slice sl, uint64_t pos);

uint32_t
Incr_counter_param_incr_counter_param_jumper(LowParse_Slice_slice input, uint32_t pos);
...
#define __Incr_counter_param_H_DEFINED
#endif
