...
uint64_t Incr_counter_param_incr_counter_param_validator(LowParse_Slice_slice sl, uint64_t pos)
{
...
uint32_t Incr_counter_param_incr_counter_param_jumper(LowParse_Slice_slice input, uint32_t pos)
{
  return pos + (uint32_t)10U;
}

Incr_counter_param_incr_counter_param
Incr_counter_param_incr_counter_param_reader(LowParse_Slice_slice input, uint32_t pos)
{
  ...
  return ((Incr_counter_param_incr_counter_param){ .k = k, .s_r = s_r });
}

uint32_t
Incr_counter_param_incr_counter_param_lserializer(
  Incr_counter_param_incr_counter_param x,
  uint8_t *input,
  uint32_t pos
)
{
...
uint32_t
Incr_counter_param_accessor_incr_counter_param_k(LowParse_Slice_slice input, uint32_t pos)
{
  return pos;
}

uint32_t
Incr_counter_param_accessor_incr_counter_param_s_r(LowParse_Slice_slice input, uint32_t pos)
{
  uint32_t pos2 = pos;
  uint32_t pos21 = pos2;
