 ...
 */
#ifndef EDGER8R_OPENENCLAVE_MCOUNTER_T_H
#define EDGER8R_OPENENCLAVE_MCOUNTER_T_H
...
/**** ECALL prototypes. ****/
void enclave_Zeta_Steel_Main_init(void);

enclave_FStar_Pervasives_Native_option__Zeta_Steel_Verifier_verify_result enclave_Zeta_Steel_Main_verify_log(
    uint16_t tid,
    uint32_t len,
    uint8_t* input,
    uint32_t out_len,
...
#endif // EDGER8R_OPENENCLAVE_MCOUNTER_T_H
