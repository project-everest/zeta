...
static const oe_ecall_info_t _openenclave_mcounter_ecall_info_table[] = 
{
...
oe_result_t openenclave_mcounter_enclave_Zeta_Steel_Main_init(oe_enclave_t* enclave)
{
    ...
    /* Marshalling struct. */
    enclave_Zeta_Steel_Main_init_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    ...
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_Zeta_Steel_Main_init_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_Zeta_Steel_Main_init_args_t));
    /* There were no corresponding parameters. */
    ...
    _pargs_in = (enclave_Zeta_Steel_Main_init_args_t*)_input_buffer;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_enclave_Zeta_Steel_Main_init].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    _pargs_out = (enclave_Zeta_Steel_Main_init_args_t*)_output_buffer;
...
OE_WEAK_ALIAS(openenclave_mcounter_enclave_Zeta_Steel_Main_init, enclave_Zeta_Steel_Main_init);

oe_result_t openenclave_mcounter_enclave_Zeta_Steel_Main_verify_log(
    oe_enclave_t* enclave,
    enclave_FStar_Pervasives_Native_option__Zeta_Steel_Verifier_verify_result* _retval,
    uint16_t tid,
    uint32_t len,
    uint8_t* input,
    uint32_t out_len,
    uint8_t* output)
{
    ...
    /* Marshalling struct. */
    enclave_Zeta_Steel_Main_verify_log_args_t _args, *_pargs_in = NULL, *_pargs_out = NULL;
    /* Marshalling buffer and sizes. */
    size_t _input_buffer_size = 0;
    size_t _output_buffer_size = 0;
    size_t _total_buffer_size = 0;
    ...
    _args.len = len;
    _args.input = input;
    _args.out_len = out_len;
    _args.output = output;

    /* Compute input buffer size. Include in and in-out parameters. */
    OE_ADD_SIZE(_input_buffer_size, sizeof(enclave_Zeta_Steel_Main_verify_log_args_t));
    /* There were no corresponding parameters. */
    
    /* Compute output buffer size. Include out and in-out parameters. */
    OE_ADD_SIZE(_output_buffer_size, sizeof(enclave_Zeta_Steel_Main_verify_log_args_t));
    /* There were no corresponding parameters. */
    ...
    /* Serialize buffer inputs (in and in-out parameters). */
    _pargs_in = (enclave_Zeta_Steel_Main_verify_log_args_t*)_input_buffer;
    OE_ADD_SIZE(_input_buffer_offset, sizeof(*_pargs_in));
    /* There were no in nor in-out parameters. */
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_enclave_Zeta_Steel_Main_verify_log].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
    ...
    /* Setup output arg struct pointer. */
    _pargs_out = (enclave_Zeta_Steel_Main_verify_log_args_t*)_output_buffer;
    OE_ADD_SIZE(_output_buffer_offset, sizeof(*_pargs_out));
    ...
    sgx_report_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_oe_get_sgx_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openenclave_mcounter_oe_get_sgx_report_ecall, oe_get_sgx_report_ecall);

oe_result_t openenclave_mcounter_oe_get_report_v2_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    uint32_t flags,
    const void* opt_params,
    ...
    oe_report_buffer_t* report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_oe_get_report_v2_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openenclave_mcounter_oe_get_report_v2_ecall, oe_get_report_v2_ecall);

oe_result_t openenclave_mcounter_oe_verify_local_report_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    ...
    oe_report_t* parsed_report)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_oe_verify_local_report_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openenclave_mcounter_oe_verify_local_report_ecall, oe_verify_local_report_ecall);

oe_result_t openenclave_mcounter_oe_sgx_init_context_switchless_ecall(
    oe_enclave_t* enclave,
    oe_result_t* _retval,
    oe_host_worker_context_t* host_worker_contexts,
    uint64_t num_host_workers)
{
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_oe_sgx_init_context_switchless_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openenclave_mcounter_oe_sgx_init_context_switchless_ecall, oe_sgx_init_context_switchless_ecall);

oe_result_t openenclave_mcounter_oe_sgx_switchless_enclave_worker_thread_ecall(
    oe_enclave_t* enclave,
    oe_enclave_worker_context_t* context)
{
    oe_result_t _result = OE_FAILURE;
    ...
    if ((_result = oe_call_enclave_function(
             enclave,
             &global_id,
             _openenclave_mcounter_ecall_info_table[openenclave_mcounter_fcn_id_oe_sgx_switchless_enclave_worker_thread_ecall].name,
             _input_buffer,
             _input_buffer_size,
             _output_buffer,
             _output_buffer_size,
...
OE_WEAK_ALIAS(openenclave_mcounter_oe_sgx_switchless_enclave_worker_thread_ecall, oe_sgx_switchless_enclave_worker_thread_ecall);
...
static oe_ocall_func_t _openenclave_mcounter_ocall_function_table[] = {
...
oe_result_t oe_create_openenclave_mcounter_enclave(
    const char* path,
