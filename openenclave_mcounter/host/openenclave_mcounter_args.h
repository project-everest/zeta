 ...
 */
#ifndef EDGER8R_OPENENCLAVE_MCOUNTER_ARGS_H
#define EDGER8R_OPENENCLAVE_MCOUNTER_ARGS_H
...
#ifndef EDGER8R_STRUCT__CASE_VERIFY_SUCCESS
#define EDGER8R_STRUCT__CASE_VERIFY_SUCCESS
typedef struct _case_Verify_success
{
    uint32_t read;
    uint32_t wrote;
} _case_Verify_success;
#endif

#ifndef EDGER8R_UNION__DUMMY
#define EDGER8R_UNION__DUMMY
typedef union _dummy
{
...
#ifndef EDGER8R_STRUCT_ENCLAVE_ZETA_STEEL_VERIFIER_VERIFY_RESULT
#define EDGER8R_STRUCT_ENCLAVE_ZETA_STEEL_VERIFIER_VERIFY_RESULT
typedef struct enclave_Zeta_Steel_Verifier_verify_result
{
    uint8_t tag;
    union _dummy dummy;
} enclave_Zeta_Steel_Verifier_verify_result;
#endif

#ifndef EDGER8R_STRUCT_ENCLAVE_FSTAR_PERVASIVES_NATIVE_OPTION__ZETA_STEEL_VERIFIER_VERIFY_RESULT
#define EDGER8R_STRUCT_ENCLAVE_FSTAR_PERVASIVES_NATIVE_OPTION__ZETA_STEEL_VERIFIER_VERIFY_RESULT
typedef struct enclave_FStar_Pervasives_Native_option__Zeta_Steel_Verifier_verify_result
{
    uint8_t tag;
    enclave_Zeta_Steel_Verifier_verify_result v;
} enclave_FStar_Pervasives_Native_option__Zeta_Steel_Verifier_verify_result;
#endif

#endif // EDGER8R_OPENENCLAVE_MCOUNTER_ARGS_H
