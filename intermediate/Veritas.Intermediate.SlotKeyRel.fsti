module Veritas.Intermediate.SlotKeyRel
...
let assoc_key (#vcfg:_) (ssm:slot_state_map vcfg) (s:slot_id vcfg{is_assoc ssm s}): key = 
  Assoc?.k (ssm s)

let is_assoc_with #vcfg (ssm:slot_state_map vcfg) (s:slot_id vcfg) (k:key): bool =
